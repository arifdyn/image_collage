...
class _CollageSample extends State<CollageSample> {
  ...
  // _preview(String imgpath) async {
  //   final Uint8List image = await _capturePng();

  //   if (image == null) return;
  //   Navigator.of(context)
  //       .push(MaterialPageRoute(builder: (_) => MyHomePage(image)));
  // }
  ...
  Future<Uint8List> _capturePng() async {
    try {
      ...
      print('image path : ' + screenshotImageFile.path);
